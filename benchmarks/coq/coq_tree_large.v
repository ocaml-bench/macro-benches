(* Coq input-size ladder rung (large): kernel reduction of a unary-nat tree size.
   make_tree 19 builds 2^19 nodes; tree_size reduces to a 2^19-deep unary nat,
...
Compute tree_size (make_tree 19).
